# Uniswap V2 Pair ABI (simplified to include only relevant parts for liquidity)
pair_abi = [
    {
        "inputs": [],
        "name": "getReserves",
...
# ERC20 Token ABI (for name function)
...
contract_abi = [
    ...
    {
        "constant": False,
        "inputs": [{"internalType": "address", "name": "_token0", "type": "address"}, {"internalType": "address", "name": "_token1", "type": "address"}],
        "name": "initialize",
        "outputs": [],
        "payable": False,
        "stateMutability": "nonpayable",
